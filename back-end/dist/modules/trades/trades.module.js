...
exports.TradesModule = TradesModule = __decorate([
    (0, common_1.Module)({ imports: [store_module_1.StoreModule], controllers: [trades_controller_1.TradesController, trades_controller_1.TradingAliasController], providers: [trades_service_1.TradesService] })
], TradesModule);
