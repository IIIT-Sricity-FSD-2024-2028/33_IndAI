...
exports.StocksModule = StocksModule = __decorate([
    (0, common_1.Module)({ imports: [store_module_1.StoreModule], controllers: [stocks_controller_1.StocksController, stocks_controller_1.MarketAliasController], providers: [stocks_service_1.StocksService] })
], StocksModule);
