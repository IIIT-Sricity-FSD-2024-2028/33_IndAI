...
exports.UpdateProgressDto = exports.CreateEnrollmentDto = void 0;
...
__decorate([
    ...
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateEnrollmentDto.prototype, "assignedBy", void 0);
class UpdateProgressDto {
}
exports.UpdateProgressDto = UpdateProgressDto;
__decorate([
    (0, swagger_1.ApiProperty)({ example: 75, minimum: 0, maximum: 100 }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['in_progress', 'completed', 'pending'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['in_progress', 'completed', 'pending'], { message: 'Invalid enrollment status.' }),
    __metadata("design:type", String)
